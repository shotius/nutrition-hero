...
const ForthSection = React.forwardRef((props, ref) => {
  return (
    <FourthSectionWrap>
      ...
      <TextWrap ref={ref}>
        <SectionHeader size="large">New app. New you</SectionHeader>
        ...
        libero, vel malesuada velit. Nullam et maximus lorem. Praesent eu dolor
        eu orci vehicula euismod. Vivamus sed sollicitudin libero, vel malesuada
        velit. Nullam et maximus lorem. Praesent eu dolor eu orci vehicula
        euismod. Vivamus sed sollicitudin libero, vel malesuada velit. Nullam et
        maximus lorem.
        <AppStoreWrap>
          <a
          ...
          <a
            ...
            style={{ cursor: "pointer" }}
          >
            <img src={googlePlayImg} alt="googlePlayLInke" />
          </a>
        </AppStoreWrap>
      </TextWrap>
    </FourthSectionWrap>
